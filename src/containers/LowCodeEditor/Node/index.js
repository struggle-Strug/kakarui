...
const CustomNode = ({ data }) => {
  ...
  return (
    <div className="px-2 py-2 bg-white border-2 rounded-md shadow-md border-stone-400">
      {/* ノードの内容 */}
      <div className="w-[250px]">
        ...
        >
          ...
          {data.type !== 'Root' && <div className="text-white">×</div>}
        </div>
        ...
        <Handle
          ...
          className="w-24 !border !border-solid !border-[#796E66] !bg-white"
        />
        <Handle
          type="source"
