  ...
  return (
    <div className="text-wh1te flex h-[60px] w-full items-center justify-between !bg-[#413D39] bg-black px-6 py-2">
      ...
      <div className="flex gap-4 text-white">
        <Button className="!rounded !border-2 !border-white !bg-black !px-6 !text-[14px] !font-bold !text-white !cursor-pointer">
          Import
        </Button>
        ...
        <div>  
          ...
          <Button
            onClick={noop}
            className="!rounded border !bg-white !px-8 !text-[14px] cursor-pointer !font-bold !text-black"
          >
            Save
          </Button>
          </SaveSequenceModal>
