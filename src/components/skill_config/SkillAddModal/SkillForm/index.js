...
import { FORM_SKILL, skillSchema } from '@/validations/skillShema'
    ...
    <FormProvider {...methods}>
      ...
      >
        <Controller
          ...
          control={control}
          render={({ field }) => <Input {...field} label="スキル名" placeholder="" />}
        />
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <InputTextArea {...field} label="スキル説明" placeholder="" rows={3} />
          )}
        />
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <InputTextArea {...field} label="スキーマ" placeholder="" rows={8} />
          )}
        />

        <Controller
          name={FORM_SKILL.TAG} // Ensure this matches your schema
          control={control}
          render={({ field }) => <Input {...field} label="タグ" placeholder="" />}
        />

        <Controller
          name={FORM_SKILL.VISIBILITY} // Use a name that matches your schema
          control={control}
          defaultValue="single" // Set default value if needed
          render={({ field }) => (
            <div className="flex items-center">
              <label className="mb-2 block min-w-[100px] text-sm font-medium">参照範囲</label>
              <Radio.Group
                {...field}
                className="flex w-full justify-center gap-8 pl-36"
